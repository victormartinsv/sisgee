 ...
 *
 */
@WebServlet("/FormAlterarTermoAditivoServlet")
public class FormAlterarTermoAditivoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ResourceBundle messages = ResourceBundle.getBundle("Messages", locale);
                ...
                System.out.println("MATRICULA DO ALUNO ALTERAR ADITIVO:" + aluno.getMatricula());
                final DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
                final Calendar cal = Calendar.getInstance();
		
                //Integer idTermoInicial = Integer.parseInt(request.getParameter("idTermo"));
                /** campos de Vigência */
		...
		String idTermoEstagioInicial = request.getParameter("idTermoEstagioInicial");
                String idTermoAditivoInicial = request.getParameter("idTermoAditivoInicial");
		...
		String showValorBolsa = request.getParameter("showValorBolsa");
                ...
                System.out.println("PARAMETRO SHOW VALOR BOLSA:" + showValorBolsa);
		...
		msg = ValidaUtils.validaObrigatorio(campo, idTermoEstagioInicial);
                System.out.println("MSG TERMO ESTAGIO:" + msg);
                System.out.println("MSG ID ESTAGIO:" + idTermoEstagioInicial);
		if (msg.trim().isEmpty()) {
			msg = ValidaUtils.validaInteger(campo, idTermoEstagioInicial);
			if (msg.trim().isEmpty()) {
				idTermo = Integer.parseInt(idTermoEstagioInicial);
				termoEstagio = TermoEstagioServices.buscarTermoEstagio(Integer.parseInt(idTermoEstagioInicial));
                                System.out.println("TESTE ID FO TERMO ESTAGIO:" + termoEstagio.getIdTermoEstagio());
			}else {
			...
			if (showValorBolsa != null && !showValorBolsa.trim().isEmpty() ) {
				...
				if (valorBolsaMsg.trim().isEmpty()) {
					...
					System.out.println(valorBolsaMsg);
                                ...
                                System.out.println("valor bolsa msg final:" + valorBolsaMsg);
			}
		...
		if (isValid) {
					...
					TermoAditivo termoAditivo1 = new TermoAditivo();
                                        ...
                                        termoAditivo1.setIdTermoAditivo(Integer.parseInt(idTermoAditivoInicial));
                                        TermoAditivoServices.alterarTermoAditivo(termoAditivo1);
                                }
                                ...
                                if(showCargaHoraria!=null && showCargaHoraria.equals("sim")) {
                                    ...
                                    termoAditivo2.setIdTermoAditivo(Integer.parseInt(idTermoAditivoInicial));
                                    TermoAditivoServices.alterarTermoAditivo(termoAditivo2);
                                }
				...
				if(showProfessor != null && showProfessor.equals("sim")) {
                                    ...
                                    termoAditivo3.setIdTermoAditivo(Integer.parseInt(idTermoAditivoInicial));
                                    TermoAditivoServices.alterarTermoAditivo(termoAditivo3);
                                }
				...
				if(showValorBolsa != null && showValorBolsa.equals("sim")) {
                                    ...
                                    termoAditivo4.setIdTermoAditivo(Integer.parseInt(idTermoAditivoInicial));
                                    TermoAditivoServices.alterarTermoAditivo(termoAditivo4);
				}
				...
				if(showLocal != null && showLocal.equals("sim")) {
					...
					termoAditivo5.setCepEnderecoTermoAditivo(cepEnderecoTermoAditivo);
                                        ...
                                        termoAditivo5.setIdTermoAditivo(Integer.parseInt(idTermoAditivoInicial));
                                        TermoAditivoServices.alterarTermoAditivo(termoAditivo5);
                                ...
                                if(showSupervisor != null && showSupervisor.equals("sim")){
                                    ...
                                    termoAditivo6.setIdTermoAditivo(Integer.parseInt(idTermoAditivoInicial));
                                    TermoAditivoServices.alterarTermoAditivo(termoAditivo6);
                                }
			...
			UF[] uf = UF.asList();
                        request.setAttribute("uf", estadoEnderecoTermoAditivo);
			...
			/** Dados de aluno*/
                        ...
                        request.setAttribute("idTermoEstagoInicial", idTermoEstagioInicial);
			...
			request.getRequestDispatcher("/form_termo_altera_aditivo.jsp").forward(request, response);
		}
