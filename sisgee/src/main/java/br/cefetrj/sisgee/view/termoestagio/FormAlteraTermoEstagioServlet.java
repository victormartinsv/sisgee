 ...
 * @version 2.0
 */
@WebServlet("/FormaAlteraTermoEstagioServlet")
public class FormAlteraTermoEstagioServlet extends HttpServlet {
    ...
    /**
     * @throws javax.servlet.ServletException * @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        System.out.println("VEIO PARA O SERVLET ALTERA");
        ...
        System.out.println(enderecoTermoEstagio);
        ...
        String estadoEnderecoTermoEstagio = request.getParameter("estadoEnderecoTermoEstagio").trim();
        System.out.println("ESTADO:" + estadoEnderecoTermoEstagio);
        String eEstagioObrigatorio = request.getParameter("eEstagioObrigatorio");
        System.out.println("Estagio Obrigatório:" + eEstagioObrigatorio);
        Boolean auxeEstagioObrigatorio;
        
        if(eEstagioObrigatorio.equals("sim")){
            auxeEstagioObrigatorio = true;
        }
        else{
            auxeEstagioObrigatorio = false;
        }
        
        String idProfessorOrientador = request.getParameter("idProfessorOrientador");
        String nomeProfessor = request.getParameter("nomeProfessorOrientador");
        
        System.out.println("ID DO PROFESSOR PARA SALVAR: " + idProfessorOrientador);
        ...
        String cnpjEcpf = request.getParameter("cnpjEcpf");
        ...
        System.out.println("IDtELA Convenio"+ idTelaConvenio);
        ...
        request.setAttribute("idTermo", idTermo);
        
        Convenio convenio2 = ConvenioServices.buscarConvenioByNumeroConvenio(numeroConvenio);
        String idConvenio = convenio2.getNumero().toString();
        
        request.setAttribute("uf", estadoEnderecoTermoEstagio);

        /** Dados de aluno*/
        request.setAttribute("alMatricula", matricula);
        request.setAttribute("alNome", nomeAluno);
        request.setAttribute("alCampus", nomeCampus);
        request.setAttribute("alCurso", nomeCurso);
        request.setAttribute("alId", idAluno);
        /** Dados de convenio*/
        request.setAttribute("cvNumero", numeroConvenio);
        request.setAttribute("idConvenio", idConvenio);
        if(tipoConvenio=="pf"){
            request.setAttribute("cvNome", nomeConvenio);
            request.setAttribute("tConvenio","pf");
            request.setAttribute("cvCpfCnpj",cnpjEcpf);
            request.setAttribute("nomeAgenciada",nomeAgenciada);

        }else{
            request.setAttribute("cvNome", nomeConvenio);
            request.setAttribute("tConvenio","pj");
            request.setAttribute("agIntegracao",isAgenteIntegracao);
            request.setAttribute("cvCpfCnpj", cnpjEcpf);
            request.setAttribute("nomeAgenciada",nomeAgenciada);
        }

        /** Dados de Vigência */
        request.setAttribute("vidataInicioTermoEstagio",dataInicioTermoEstagio);
        request.setAttribute("vidataFimTermoEstagio",dataFimTermoEstagio);

        /** Dados de Carga Horária */
        request.setAttribute("cacargaHorariaTermoEstagio",cargaHorariaTermoEstagio);

        /** Dados de Valor Bolsa */
        request.setAttribute("vavalorBolsa",valorBolsa);
        System.out.println("aqui"+ valorBolsa);
        /** Dados de Local */
        request.getServletContext().setAttribute("enenderecoTermoEstagio",enderecoTermoEstagio);
        request.setAttribute("ennumeroEnderecoTermoEstagio",numeroEnderecoTermoEstagio);
        request.setAttribute("encomplementoEnderecoTermoEstagio",complementoEnderecoTermoEstagio);
        request.setAttribute("enbairroEnderecoTermoEstagio",bairroEnderecoTermoEstagio);
        request.setAttribute("encidadeEnderecoTermoEstagio",cidadeEnderecoTermoEstagio);
        request.setAttribute("enuf",estadoEnderecoTermoEstagio);
        request.setAttribute("encepEnderecoTermoEstagio",cepEnderecoTermoEstagio);

        /** Dados de Supervisor */

        request.setAttribute("eobrigatorio", auxeEstagioObrigatorio);
        request.setAttribute("nomeSupervisor",nomeSupervisor);
        request.setAttribute("cargoSupervisor",cargoSupervisor);

        /** Dados de Professor */
        request.setAttribute("pfnomeprofessor",nomeProfessor);
        
        request.setAttribute("idProfessor",idProfessorOrientador);
        ...
        System.out.println("msg final bolsa: " + valorBolsaMsg);
        /**
        ...
        System.out.println("Testando esse id aluno:" +idAluno);
        if (idAlunoMsg.trim().isEmpty()) {
            idAlunoMsg = ValidaUtils.validaInteger(campo, idAluno);
            System.out.println("Mensagem do id aluno:" + idAlunoMsg);
        ...
        */
        ...
        System.out.println("msg final idAluno" + idAlunoMsg);
        System.out.println("msg final idProfessor" + idProfessorMsg);
        System.out.println("msg final cargahoraria" + cargaHorariaMsg);
        System.out.println("msg final dataInicio" + dataInicioMsg);
        System.out.println("msg final dataFim" + dataFimMsg);
        
        System.out.println("msg final valorBolsa" + valorBolsaMsg);
        System.out.println("msg final endereco" + enderecoMsg);
        System.out.println("msg final numero" + numeroEnderecoMsg);
        System.out.println("msg final complemento" + complementoEnderecoMsg);
        System.out.println("msg final bairro" + bairroEnderecoMsg);
        System.out.println("msg final cidade" + cidadeEnderecoMsg);
        System.out.println("msg final cep: " + cepEnderecoMsg);
        System.out.println("msg final nomesupervisor: " + nomeSupervisorMsg);
        System.out.println("msg final cargo: " + cargoSupervisorMsg);
        System.out.println("msg final cep: " + cepEnderecoMsg);
        System.out.println("msg final UF: " + estadoEnderecoMsg);
        
        
        if (isValid) {
            
            request.getRequestDispatcher("/IncluirAlterarTermoEstagioServlet").forward(request, response);
            ...
            request.getRequestDispatcher("/form_termo_Altera.jsp").forward(request, response);
        }
    }
