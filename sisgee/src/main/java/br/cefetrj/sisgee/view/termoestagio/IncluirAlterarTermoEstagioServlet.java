...
@WebServlet("/IncluirAlterarTermoEstagioServlet")
public class IncluirAlterarTermoEstagioServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		termoEstagio.setIdTermoEstagio(Integer.parseInt(idTermo));
                
		String msg = "";
		Logger lg = Logger.getLogger(IncluirAlterarTermoEstagioServlet.class);
		try{
			
			TermoEstagioServices.alterarTermoEstagio(termoEstagio);
			msg = "Termo de Estágio alterado com sucesso";
			...
			request.setAttribute("msg", msg);
			System.out.println("Erro no Try Catch do IncluirAlterarTermoEstagioServlet " + e);
