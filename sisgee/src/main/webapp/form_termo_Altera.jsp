    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="FormTermoAditivoServlet" method="post">
                ...
                <fieldset class="form-group" }>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control col-sm-4 " id="dataFimTermoEstagio"   name="dataFimTermoEstagio" value="${showVigencia eq 'sim' ? '' : vidataFimTermoEstagio }" ${ showVigencia eq 'sim' ? '' :''} >
                ...
                <fieldset class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" required="required" maxlength="1" pattern="[1-6]+$" class="form-control col-sm-2 " id="cargaHorariaTermoEstagio" name="cargaHorariaTermoEstagio" value="${ showCargaHoraria eq 'sim' ? '' :cacargaHorariaTermoEstagio }" ${ showCargaHoraria eq 'sim' ? '' :''}>
                ...
                <fieldset class="form-group" ${ showSupervisor eq 'sim' ? '' :''}>
                ...
                <fieldset class="form-group" ${ showProfessor eq 'sim' ? '' :''}>
